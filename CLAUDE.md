...
- [ ] Lottie: `robot/guide`, `lot/reveal-paper`, `wheel/win-burst` — **인프라만 완료** (`LazyLottie`가 `/lottie/robot/<scene>/lottie.json`을 lazy load, 없으면 마스코트 PNG fallback). 씬 JSON 제작은 §5.1 워크플로로 다음 단계에 진행
